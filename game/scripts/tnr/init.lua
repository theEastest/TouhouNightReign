return {
    ...
    MarisaDefinition = require("tnr.character.marisa_definition"),
    SanaeDefinition = require("tnr.character.sanae_definition"),
    CharacterCatalog = require("tnr.character.character_catalog"),
