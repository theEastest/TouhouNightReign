...
function ModifierDefinition.new(spec)
    ...
    local base = EquipmentDefinition.new({
        ...
        display_name = spec.display_name_zh or spec.display_name or spec.name or spec.modifier_id,
        display_name_zh = spec.display_name_zh or spec.display_name or spec.name or spec.modifier_id,
        display_name_en = spec.display_name_en or spec.name or spec.display_name or spec.modifier_id,
    ...
    data.description_zh = spec.description_zh or spec.description
