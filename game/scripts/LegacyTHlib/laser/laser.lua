...
-- Original THlib laser node atlas. The activity cards use this image for
-- laser endpoints and expect the eight-frame `laser_node1..8` group.
...
function laser:init(index, x, y, rot, l1, l2, l3, w, node, head)
    ...
    -- The source THlib shares each node/head frame between two laser colors.
