frozen_background=Class(object)

function frozen_background:init()
	background.init(self,false)
	LoadImageFromFile('frozenground','frozenground.png')
	--LoadTexture('mask2','THlib\\background\\magic_forest\\mask.png')
	LoadImageFromFile('mask2','mask2.png')
	Set3D('z',1,20)
...
function frozen_background:frame()
...
function frozen_background:render()
	SetViewMode'3d'
	...
	local y=self.yos%1
	for i=-1,2 do
		Render4V('frozenground',0,0-y+i,0,0,1-y+i,0,1,1-y+i,0,1,-y+i,0)
		Render4V('frozenground',-1,0-y+i,0,-1,1-y+i,0,0,1-y+i,0,0,-y+i,0)
	end
	for i=-1,3 do
		Render4V('mask2',0,0-y+i,-0.2,0,1-y+i,-0.2,1,1-y+i,-0.2,1,-y+i,-0.2)
		Render4V('mask2',-1,0-y+i,-0.2,-1,1-y+i,-0.2,0,1-y+i,-0.2,0,-y+i,-0.2)
	end
