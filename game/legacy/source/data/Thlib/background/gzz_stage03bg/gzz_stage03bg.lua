gzz_stage03bg=Class(object)

function gzz_stage03bg:init()
	--
...
function gzz_stage03bg.renderwall(z)
	Render4V('gzz_stage03c',4,2,z-1,4,2,z+1,4,0,z+1,4,0,z-1)
end

function gzz_stage03bg.renderchina(x1,x2,y1,y2,r,z)
	local i=1
...
function gzz_stage03bg.renderlightL(x,y,z,size,t)
...
function gzz_stage03bg.renderlightR(x,y,z,size,t)
