redsky_background=Class(background)

function redsky_background:init()
	background.init(self,false)
	LoadTexture('magic_forest_ground','THlib\\background\\redsky\\ground.png')
	LoadImage('magic_forest_ground','magic_forest_ground',0,360,1000,1300)
	LoadTexture('magic_forest_mask','THlib\\background\\redsky\\mask.png')
...
function redsky_background:frame()
	self.yos=self.yos+self.speed
end

function redsky_background:render()
	SetViewMode'3d'
