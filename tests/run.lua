...
local DropRewardSpec = require("drop_reward_spec")
...
local CharacterStatsSpec = require("character_stats_spec")
...
DropRewardSpec(assert_equal, assert_true)
...
CharacterStatsSpec(assert_equal, assert_true)
